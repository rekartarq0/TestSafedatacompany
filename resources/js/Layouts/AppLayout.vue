                    ...
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-4 sm:-my-px sm:ms-5 sm:flex">
                                ...
                                <!-- bakarhenarakan -->
                                <nav class="text-black inline-flex items-center
        ...
        focus:outline-none focus:border-indigo-700 transition duration-150 ease-in-out" :class="{
            ...
            '': !route().current('users.index')
                                ...
                                <NavLink :href="route('authors.index')" :active="route().current('authors.index')"
                                    :class="{ 'border-b-2 border-black': route().current('authors.index') }">
                                    <h4 class="font-bold font-droidkufi text-black dark:text-black pl-1 sm:pl-2">
                                        نووسەرەکان
                                    </h4>
                                </NavLink>
                                ...
                                <NavLink :href="route('posts.index')" :active="route().current('posts.index')"
                                    :class="{ 'border-b-2 border-black': route().current('posts.index') }">
                                    <h4 class="font-bold font-droidkufi text-black dark:text-black pl-1 sm:pl-2">
                                        پۆستەکان
                                    </h4>
                                </NavLink>
